...
<div class="header-top">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <div class="welcome-tx">Welcome to Happy Kid !</div>
            </div>
            <div class="col-md-6">
            </div>
        </div>
...
<div class="header-mid">
    <div class="container">
        <div class="row">
            <div class="col-md-5">
                <div class="logo">
                    <div class="lname"><a href=""><span><h4>Happy Kids</h4></span></a></div>
                </div>
            </div>
            <div class="col-md-7">
                <div class="row">
...
<!--==== About Us ====-->
<main>
    <div class="container content-HS">
    <h2>What is Happy Kid?</h3>
    <p>Happy Kid is local bookstore selling kid books.</p>
    </div>
