...
<div class="row">
	<div class="col-lg-6">
		...
		<?= form_open('checkout')?>
			...
			<p>Now we have only option credit card.Thanks for your supports</p>
			...
			<br><div><p>We will contact with you within 24 hours. Please read our shipping policy at <a href="<?= base_url()?>users/terms" target ="_blank" class="text-primary">terms and condition</a> page. If you agree with our shipping policy then place your order now.</p></div>
			<div class="sub">
	...
	<div class="col-lg-6">
		...
		<?php
			...
			print "<td colspan = '2'>RM ".$shipping."</td>";
			print "</tr>";
