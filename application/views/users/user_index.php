...
<div class="admin-index section-padding">
	<div class="user-heading text-center">
        ...
        <p>You can see your book informations. You can track your order from here, and you can see your order details. You can also edit your profile information from here, such as your name, password and other informations.</p>   
    </div>
</div>
<div class="row">
    <div class="col-lg-5">
