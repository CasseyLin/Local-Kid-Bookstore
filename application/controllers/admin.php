...
/*================ Category Detail display page ================*/
	...
	{
		//loads the admin_model
		$this->load->model('admin_model');
		//The $ctg_detail refer to get_ctg_detail($id) from admin_model
...
/*================ Add Books Page =================*/
	...
	public function book_edit($id)
	{
		...
		else
		{
			...
			{
				$this->session->set_flashdata('success', 'Book info updated successfully');
				redirect('admin/books');
			}
			else
			{
	...
	{
		$this->load->model('admin_model');
		//$order_detail refer to get_order_detail($orderId) in admin_model
		$view['order_detail'] = $this->admin_model->get_order_detail($orderId);

		//if successfully get order detail 
		if($this->admin_model->get_order_detail($orderId))
		{
			$view['admin_view'] = "admin/delivery_details";
			//load the view in admin_layout
			$this->load->view('layouts/admin_layout', $view);
		}
		else
		{
